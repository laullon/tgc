		...
		<div id="historia" class="der">
			<form action="/tarjeta/<?php tgc_numero_targeta() ?>/"  method="post">
				...
				<div class="tarjetaPartI">
					...
					<input type="text" id="tgc_" name="pais" class="TboxLugarPais"/><input type="text" id="tgc_" name="provincia" class="TboxLugar"/><input type="text" id="tgc_date" name="localidad" class="TboxLugar"/>
				</div><br/>
