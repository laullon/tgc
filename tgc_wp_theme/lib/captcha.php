...
function tgc_SimpleCaptcha() {
    echo '<div class="seccion clearfix">';
    echo '<label for="captcha">Seguridad</label>';
    echo '<img class="clearfix" src="/captcha/' . rand(10, 20) . '" width="200" height="70"/>';
    echo '<input type="text" id="captcha" name="captcha"/>';
    echo '</div>';
}

function tgc_SimpleCaptcha_image() {
    session_start();
...
class SimpleCaptcha {
    ...
    public function CreateImage() {
        ...
        error_log(">>" . $_SESSION[$this->session_var]);
        error_log("*>" . $text);
